...
class ParseFunc {
    ...
    class func getParseObject(objectID:String, pfClass: String, objFunc: (object: PFObject) -> ()) {
    ...
    class func loadParseImage (pfFile: PFFile, getParseImage: (UIImage) -> ()) -> (){
...
@objc protocol ParseQueryHandler: NSObjectProtocol {
    ...
    optional func handleSecondQueryResults(objects: [PFObject])
